    ...
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="flex justify-between items-center mb-8">
           ...
           <Badge variant="outline" className="text-[9px] font-black tracking-widest text-slate-500 border-slate-800">PORT 443 SECURE</Badge>
        </div>
...
function Badge({ children, className, variant = 'default' }: any) {
  return (
    <div className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-bold ${className}`}>
      {children}
    </div>
  );
}